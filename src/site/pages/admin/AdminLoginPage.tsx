      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-comfortable border border-border-default bg-surface-frost-02 px-4 py-2.5 text-caption-lg text-text-secondary transition-colors hover:bg-surface-frost-05 hover:text-text-primary disabled:opacity-50"
          >
