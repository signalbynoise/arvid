...
import { SARAH, ARVID, DAVID } from '../mini-demo/actors';

const contentPool: ContentPool = {
  requirements: [
    { id: 'r1', shortId: 'R01', title: 'User authentication with SSO support', owner: 'Sarah K.', createdAt: 'May 1', completeness: 85, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Implemented', deployStatus: 'Live' },
    { id: 'r2', shortId: 'R02', title: 'Real-time notifications system', owner: 'James L.', createdAt: 'Apr 29', completeness: 42, clarity: 'Medium', risk: 'Medium', status: 'In progress', implStatus: 'Partially implemented', deployStatus: 'Not deployed' },
    { id: 'r3', shortId: 'R03', title: 'Data export & reporting module', owner: 'Emily R.', createdAt: 'Apr 25', completeness: 15, clarity: 'Low', risk: 'High', status: 'Pre backlog', implStatus: 'Not implemented' },
    { id: 'r4', shortId: 'R04', title: 'Role-based access control', owner: 'David M.', createdAt: 'Apr 22', completeness: 68, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Partially implemented', deployStatus: 'Not deployed' },
    { id: 'r5', shortId: 'R05', title: 'Audit log for compliance', owner: 'Sarah K.', createdAt: 'Apr 20', completeness: 30, clarity: 'Medium', risk: 'High', status: 'Refinement', implStatus: 'Not implemented' },
    { id: 'r6', shortId: 'R06', title: 'Webhook event delivery', owner: 'David M.', createdAt: 'Apr 18', completeness: 55, clarity: 'Medium', risk: 'Medium', status: 'In progress', implStatus: 'Partially implemented', deployStatus: 'Deploy failed' },
    { id: 'r7', shortId: 'R07', title: 'Multi-tenant data isolation', owner: 'Emily R.', createdAt: 'Apr 15', completeness: 72, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Implemented', deployStatus: 'Live' },
    { id: 'r8', shortId: 'R08', title: 'File upload & attachment support', owner: 'James L.', createdAt: 'Apr 12', completeness: 10, clarity: 'Low', risk: 'Medium', status: 'Pre backlog', implStatus: 'Not implemented' },
    { id: 'r9', shortId: 'R09', title: 'Search & filtering engine', owner: 'David M.', createdAt: 'Apr 10', completeness: 48, clarity: 'Medium', risk: 'Low', status: 'In progress', implStatus: 'Partially implemented', deployStatus: 'Not deployed' },
    { id: 'r10', shortId: 'R10', title: 'CI/CD pipeline integration', owner: 'Sarah K.', createdAt: 'Apr 8', completeness: 25, clarity: 'Low', risk: 'High', status: 'Pre backlog', implStatus: 'Not implemented' },
    { id: 'r11', shortId: 'R11', title: 'Email digest scheduling', owner: 'Emily R.', createdAt: 'Apr 5', completeness: 60, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Implemented', deployStatus: 'Live' },
    { id: 'r12', shortId: 'R12', title: 'GraphQL API gateway', owner: 'David M.', createdAt: 'Apr 3', completeness: 38, clarity: 'Medium', risk: 'Medium', status: 'Refinement', implStatus: 'Not implemented' },
    { id: 'slack-1', shortId: 'R13', title: 'API rate limiting for public endpoints', owner: 'Sarah K.', createdAt: 'Today', completeness: 0, clarity: 'Low', risk: 'High', status: 'Pre backlog', implStatus: 'Not implemented' },
    { id: 'slack-2', shortId: 'R14', title: 'Webhook delivery retry logic', owner: 'Sarah K.', createdAt: 'Today', completeness: 0, clarity: 'Low', risk: 'Medium', status: 'Pre backlog', implStatus: 'Not implemented' },
    { id: 'slack-3', shortId: 'R15', title: 'Browser push notification opt-in', owner: 'Sarah K.', createdAt: 'Today', completeness: 0, clarity: 'Low', risk: 'Medium', status: 'Pre backlog', implStatus: 'Not implemented' },
  ],
  questions: {
    _default: [
