...
const contentPool: ContentPool = {
  requirements: [
    { id: 'r1', shortId: 'R01', title: 'User authentication with SSO support', owner: 'Sarah K.', createdAt: 'May 1', completeness: 85, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Implemented' },
    { id: 'r2', shortId: 'R02', title: 'Real-time notifications system', owner: 'James L.', createdAt: 'Apr 29', completeness: 42, clarity: 'Medium', risk: 'Medium', status: 'In progress', implStatus: 'Partially implemented' },
    ...
    { id: 'r4', shortId: 'R04', title: 'Role-based access control', owner: 'David M.', createdAt: 'Apr 22', completeness: 68, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Partially implemented' },
    ...
    { id: 'r6', shortId: 'R06', title: 'Webhook event delivery', owner: 'David M.', createdAt: 'Apr 18', completeness: 55, clarity: 'Medium', risk: 'Medium', status: 'In progress', implStatus: 'Partially implemented' },
    { id: 'r7', shortId: 'R07', title: 'Multi-tenant data isolation', owner: 'Emily R.', createdAt: 'Apr 15', completeness: 72, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Implemented' },
    ...
    { id: 'r9', shortId: 'R09', title: 'Search & filtering engine', owner: 'David M.', createdAt: 'Apr 10', completeness: 48, clarity: 'Medium', risk: 'Low', status: 'In progress', implStatus: 'Partially implemented' },
    ...
    { id: 'r11', shortId: 'R11', title: 'Email digest scheduling', owner: 'Emily R.', createdAt: 'Apr 5', completeness: 60, clarity: 'High', risk: 'Low', status: 'In progress', implStatus: 'Implemented' },
